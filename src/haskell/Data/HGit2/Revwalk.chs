...
pushWalk (RevWalk rfp) (OID ofp) =
  withForeignPtr rfp $ \r ->
  withForeignPtr ofp $ \o ->
  retMaybe =<< {#call git_revwalk_push#} r o
...
hideWalk (RevWalk rfp) (OID ofp) =
  withForeignPtr rfp $ \r ->
  withForeignPtr ofp $ \o ->
  retMaybe =<< {#call git_revwalk_hide#} r o
